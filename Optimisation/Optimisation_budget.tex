...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{one\PYZus{}dev\PYZus{}cost} \PY{o}{=} \PY{l+m+mi}{20}
\PY{n}{one\PYZus{}host\PYZus{}cost} \PY{o}{=} \PY{l+m+mi}{2}
\PY{n}{budget} \PY{o}{=} \PY{l+m+mi}{2500}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Heures de dev}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Heure de serveur}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\PY{l+s+sd}{    et du nombre d’heure de serveur utiliser.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{k}{return} \PY{n}{dev}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{3}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)} \PY{o}{*} \PY{n}{host}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{7}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
<ipython-input-9-9c6593fc3498>:7: MatplotlibDeprecationWarning: Calling gca()
...
\PY{n}{ax\PYZus{}l}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{dev\PYZus{}axis}\PY{p}{,} \PY{n}{n\PYZus{}host}\PY{p}{(}\PY{n}{dev\PYZus{}axis}\PY{p}{,} \PY{l+m+mi}{2500}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{ax\PYZus{}l}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of dev hours bought}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{ax\PYZus{}l}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of host hours bought}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\PY{n}{ax\PYZus{}r}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{dev\PYZus{}axis}\PY{p}{,} \PY{n}{n\PYZus{}host}\PY{p}{(}\PY{n}{dev\PYZus{}axis}\PY{p}{,} \PY{l+m+mi}{2500}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{ax\PYZus{}r}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of dev hours bought}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{ax\PYZus{}r}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of host hours bought}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
sur le graphe ci-dessus à droite.
...
\PY{n}{s}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{l} \PY{o}{=} \PY{n}{symbols}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{s t l}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{n}{solve}\PY{p}{(}\PY{p}{[}\PY{n}{Eq}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{21}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{p}{(}\PY{n}{t}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n}{s}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{l}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,}
   \PY{n}{Eq}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{7}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{n}{s}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{3}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)}\PY{o}{/}\PY{n}{t}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{3}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{l+m+mi}{20}\PY{o}{*}\PY{n}{l}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,}
   \PY{n}{Eq}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{s}\PY{o}{+}\PY{l+m+mi}{20}\PY{o}{*}\PY{n}{t} \PY{o}{\PYZhy{}} \PY{l+m+mi}{2500}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{s}\PY{p}{,}\PY{n}{t}\PY{p}{,}\PY{n}{l}\PY{p}{]}\PY{p}{,} \PY{n}{simplify}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)} 
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{revenues}\PY{p}{(}\PY{l+m+mi}{1875}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{125}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{Out}{outcolor}{15}{}
    ...
    $\displaystyle \frac{875 \cdot 30^{\frac{3}{4}}}{4}$

    

    Ce qui équivaut à un bénéfice maximum de 2804, pour 75 heures de
développement et 2,5
