...
\PY{n}{one\PYZus{}host\PYZus{}cost} \PY{o}{=} \PY{l+m+mi}{200}
\PY{n}{budget} \PY{o}{=} \PY{l+m+mi}{15000}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{n} \PY{o}{=} \PY{l+m+mi}{500} \PY{c+c1}{\PYZsh{} Coeff du retour sur investissement (x5)}
\PY{n}{p} \PY{o}{=} \PY{l+m+mi}{5}  \PY{c+c1}{\PYZsh{} Coefficient d’efficacité des ventes entre dev / host}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{revenues}\PY{p}{(}\PY{n}{dev}\PY{p}{,} \PY{n}{host}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Équation pragmatique du marketing qui exprime le bénéfice en }
\PY{l+s+sd}{    fonction du nombre de développeur}
\PY{l+s+sd}{    et du nombre de serveur.\PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
<ipython-input-10-9c6593fc3498>:7: MatplotlibDeprecationWarning: Calling gca()
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{nombre de serveur:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{solutions}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{n}{s}\PY{p}{]}\PY{o}{.}\PY{n}{n}\PY{p}{(}\PY{p}{)}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{nombre de dev :}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{solutions}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{n}{t}\PY{p}{]}\PY{o}{.}\PY{n}{n}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
('nombre de serveur:', 14.5161290322581, 'nombre de dev :', 3.02419354838710)
\end{Verbatim}
\end{tcolorbox}
        
    Ce qui équivaut à un bénéfice maximum de 5303/mois, pour 3 développeurs
et 14 serveurs
